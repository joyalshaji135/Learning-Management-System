                    ...
                    <div class="area-box">
                        <div class="row">
                            ...
                            <div class="col-sm-10 area-box-info">
                                <h4><a href="#feature" class="title-head">Edit Account</a></h4>
                                <p class="mt-3"></p>
                                <a class="btn btn-primary btn-style mt-4" href="./account_edit.php">Edit<span class="fa fa-chevron-right ml-2" aria-hidden="true"></span></a>
                            </div>
                ...
                <div class="col-md-6 grids-feature mt-4">
                    <div class="area-box">
                        <div class="row">
                            ...
                            <div class="col-sm-10 area-box-info">
                                <h4><a href="#feature" class="title-head">Change Password</a></h4>
                                <p class="mt-3"></p>
                                <a class="btn btn-primary btn-style mt-4" href="./change_password.php">Edit<span class="fa fa-chevron-right ml-2" aria-hidden="true"></span></a>
                            </div>
